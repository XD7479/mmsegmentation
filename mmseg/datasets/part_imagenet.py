...
class PartImageNetDataset(CustomDataset):
    ...
    CLASSES = ('Mammal Head', 'Mammal Body', 'Mammal Foot', 'Mammal Tail', 'Monkey Head', 
               ...
               'Fish Body', 'Fish Fin', 'Fish Tail', 'Bird Head', 'Bird Body', 'Bird Wing',
               'Bird Foot', 'Bird Tail', 'Snake Head', 'Snake Body', 'Reptile Head',
               'Reptile Body', 'Reptile Foot', 'Reptile Tail', 'Motor Vehicle Body',
